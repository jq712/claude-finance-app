...
The next task is finishing Milestone 7 (production deployment — systemd units, CI's Docker-shaped jobs, then real provisioning on the VPS per `docs/runbooks/deploy.md`), then Milestone 8 (Plaid webhook). Start a Claude Code session in this directory and:
