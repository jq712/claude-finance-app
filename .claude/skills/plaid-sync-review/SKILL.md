...
sync-semantics notes, and ADR-003/ADR-012. Any change to sync semantics is Class B (CLAUDE.md's
...
`.claude/skills/safe-migration/SKILL.md`) so a full or partial re-sync of already-seen data
