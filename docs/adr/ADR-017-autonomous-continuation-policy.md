...
1. **Class A's authority was written as "merge, and deploy"** (handoff §25, mirrored in
   ...
   2026-09-13 the "VPS" itself is shared with the engineering workspace — ADR-007/ADR-010 — but
   the production side of that boundary still doesn't exist). But the *wording*
